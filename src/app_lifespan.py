...
from src.llm.embedding_providers import EmbeddingModelFactory,HuggingFaceProvider,OpenAIProvider
load_dotenv()
...
async def lifespan(app: FastAPI):
    ...
    app.state.embedding_factory = factory
    
    # Prepare the embedding model
    embedding_provider = factory.create(app_config.embedding['model_provider'],app_config.embedding['embedding_model'])
    ...
    # Create the ChatBot instance by injecting the prepared components
